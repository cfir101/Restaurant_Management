...
class TestEmployee(unittest.TestCase):
    def setUp(self):
        self.employee1 = Employee(1, "John Doe", "john@example.com", "1234567890", "123 Main St", "Manager", "All Access")
        self.employee2 = Employee(2, "Jane Smith", "jane@example.com", "9876543210", "456 Elm St", "Chef", "All Access")
    ...
    def test_employee_attributes(self):
        ...
        self.assertEqual(self.employee1.address, "123 Main St")
...
class TestEmployeeData(unittest.TestCase):
    def setUp(self):
        ...
        self.employee_list = [
            Employee(1, "John Doe", "john@example.com", "1234567890", "123 Main St", "Manager", "All Access"),
            Employee(2, "Jane Smith", "jane@example.com", "9876543210", "456 Elm St", "Chef", "All Access"),
        ]
    ...
    def test_read_data(self):
        ...
        for actual_employee, expected_employee in zip(actual_employee_list, expected_employee_list):
            ...
            self.assertEqual(actual_employee.address, expected_employee.address)
            self.assertEqual(actual_employee.role, expected_employee.role)
